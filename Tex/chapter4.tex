...
%			\EndFor
	...
	\begin{figure}[!h]
		...
		\begin{subfigure}[b]{\twof\textwidth}
			\includegraphics[width=\textwidth]{ecdsaadaloss}
			\caption{负对数交叉熵损失}
		...
		\end{subfigure}
		\\
		\bicaption{\enspace 采用自适应数据增强方法的DL-SCA训练和验证结果}{\enspace Training and validation results of DL-SCA with adaptive DA}
		\label{fig:ecdsaada}
	\end{figure}
